...
def draw_oil_pressure(
    ...
    rect = pygame.Rect(x, OIL_PRESSURE_Y, COLUMN_WIDTH, OIL_PRESSURE_HEIGHT)
    ...
    value_surf = font_value.render(f"{oil_pressure_psi:.1f}", True, pygame.Color(CYAN))
    unit_surf = font_label.render("PSI", True, pygame.Color(CYAN))
